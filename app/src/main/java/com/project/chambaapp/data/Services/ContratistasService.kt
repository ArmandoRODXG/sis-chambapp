...
interface ContratistasService {
    ...
    @POST("/trabajos")
    fun registrarTrabajo(@Body body: TrabajoRequest): Call<Void>

    @GET("/trabajos/{idContratista}")
    fun obtenerTrabajos(@Path("idContratista") idContratista: Int): Call<List<TrabajoItem>>
}